// Webhooks de déploiement : un jeton par service ou par pile, montré UNE
// SEULE fois à sa génération — comme un jeton d'API, jamais relu ensuite,
// même chiffré. Le formulaire ne peut que le régénérer.
