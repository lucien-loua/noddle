...
import {
  ...
  PostgresqlIcon,
  RedisIcon,
} from "@/components/database-icons";
import { cn } from "@/lib/utils";

export type { DatabaseEngine } from "@noddle/shared/database-engines";

/** Re-exported under its old name: three screens already import it this way. */
export const ENGINE_LABEL = DATABASE_ENGINE_LABEL;
