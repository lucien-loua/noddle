...
const iconTileVariants = cva(
  ...
  ],
  {
    ...
    variants: {
      ...
      radius: {
        default:
          "[--icon-tile-radius:min(var(--radius-md),calc(var(--icon-tile-size)/3))] [--icon-tile-radius:min(var(--radius-xl),calc(var(--icon-tile-size)/4))]",
...
function IconTile({
  ...
  const defaultProps = {
    className: cn(iconTileVariants({ className, radius, size, variant })),
    "data-size": size,
    "data-slot": "icon-tile",
