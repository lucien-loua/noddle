...
const resourceFormSchema = z
  .object({
    cpuLimit: z.number({ error: "Enter a CPU limit." }).nullable(),
    cpuReservation: z.number({ error: "Enter a CPU reservation." }).nullable(),
    memLimit: z.number({ error: "Enter a memory limit." }).nullable(),
    memReservation: z
