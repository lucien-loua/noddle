...
export async function ensureRegistryTrust(
  ...
  // An EXTERNAL registry presents a certificate from a public CA: there's
  // nothing to deposit, and writing an empty `ca.crt` would break the
  // verification the daemon was already doing perfectly well on its own.
