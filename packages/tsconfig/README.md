...
Comments are not in `base.json`: editors and Biome treat `.json` as strict JSON, and comments break parsing there. Non-obvious choices are therefore documented here.
